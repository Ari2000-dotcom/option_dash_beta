...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex items-center px-2 text-[12px] text-[#787B86] bg-[#2A2E39] border border-[#2A2E39] select-none shrink-0",
...
>(({ className, ...props }, ref) => (
  <input
    ref={ref}
    className={cn(
      "flex-1 min-w-0 h-7 px-2.5 text-[13px] text-[#D1D4DC] bg-[#1E222D] border border-[#2A2E39]",
...
>(({ className, ...props }, ref) => (
  <textarea
    ref={ref}
    className={cn(
      "flex-1 min-w-0 px-2.5 py-1.5 text-[13px] text-[#D1D4DC] bg-[#1E222D] border border-[#2A2E39]",
...
>(({ className, ...props }, ref) => (
  <button
    ...
    className={cn(
      ...
      "bg-[#2A2E39] border border-[#2A2E39] text-[#D1D4DC]",
      "transition-colors duration-100 cursor-pointer",
      "hover:bg-[#363A45] hover:text-[#fff]",
      "disabled:opacity-40 disabled:cursor-not-allowed",
      "first:rounded-l last:rounded-r",
      "[&:not(:first-child)]:border-l-0 [&:not(:last-child)]:border-r-0",
      className,
